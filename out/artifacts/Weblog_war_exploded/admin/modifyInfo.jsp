...
<div id="p" class="easyui-panel" title="修改个人信息" style="padding: 10px">
	<form id="form1" action="/admin/bloggerServlet" method="get" enctype="multipart/form-data">
		<input type="hidden" name="way" value="updateBlogger">
		<table cellspacing="20px">
			...
			<tr>
				<td>个人头像：</td>
				<td><input type="file" id="imageFile" name="imageFile" value="${currentUser.imageName }" style="width: 400px;"/></td>
			</tr>
			<tr>
				<td valign="top">个人简介：</td>
				<td>
					<%--<script id="proFile" type="text/plain"  name="proFile" value="${currentUser.profile }" style="width:100%;height:500px;"></script>
					<input type="hidden" id="pF" name="proFile"/>--%>
					<textarea rows="8" cols="90" id="pro" >${currentUser.profile}</textarea>
						<%--<input type="text" id="proFile" value="${currentUser.profile}">--%>
