...
<script type="text/javascript">
	...
	function openPasswordModifyDialog(){
		...
		url="${pageContext.request.contextPath}/admin/bloggerServlet?way=updateBloggerPwd&id=${currentUser.id}";
	}
	...
	function logout(){
		$.messager.confirm("系统提示","您确定要退出系统吗？",function(r){
			if(r){
				window.location.href='${pageContext.request.contextPath}/blogServlet?way=getBlogsList';
			} 
		 });
	}
	...
	function refreshSystem(){
		...
		$.messager.confirm("系统提示","您确定要刷新缓存吗？",function(r){
			if(r){
				if(window.parent == window){
					window.parent.location.reload(true);
				}
...
<div region="north" style="height: 78px;background-color: #E0ECFF;overflow:hidden">
	<table style="padding: 5px" width="100%">
		<tr>
			<td width="50%">
				<img style="margin-top: -90px;" alt="logo" src="${pageContext.request.contextPath}/static/images/稷下时光.png">
			</td>
	...
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px"><font color="#ff4500" size="10">欢迎使用！</font></div>
		</div>
	</div>
</div>
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		<div title="常用操作" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
			...
			<a href="javascript:openTab('评论审核','commentServlet?way=getCommentState','icon-review')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-review'" style="width: 150px">评论审核</a>
		</div>
		<div title="博客管理"  data-options="iconCls:'icon-bkgl'" style="padding:10px;">
			<a href="javascript:openTab('写博客','writeBlog.jsp','icon-writeblog')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-writeblog'" style="width: 150px;">写博客</a>
			<a href="javascript:openTab('博客信息管理','blogAndTypeServlet?way=getBlogAndTypeList','icon-bkgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bkgl'" style="width: 150px;">博客信息管理</a>
<%--			<a href="javascript:openTab('博客信息管理','blogManage.jsp','icon-bkgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bkgl'" style="width: 150px;">博客信息管理</a>--%>
		...
		<div title="博客类别管理" data-options="iconCls:'icon-bklb'" style="padding:10px">
 			<a href="javascript:openTab('博客类别信息管理','blogTypeServlet?way=getBlogTypeCountList','icon-bklb')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bklb'" style="width: 150px;">博客类别信息管理</a>
...
<%--			<a href="javascript:openTab('评论审核','commentServlet?way=getCommentState&state=0','icon-review')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-review'" style="width: 150px">评论审核</a>--%>
			<a href="javascript:openTab('评论审核','commentServlet?way=getCommentState','icon-review')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-review'" style="width: 150px">评论审核</a>
<%--			<a href="javascript:openTab('评论信息管理','commentManage.jsp','icon-plgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-plgl'" style="width: 150px;">评论信息管理</a>--%>
			<a href="javascript:openTab('评论信息管理','commentServlet?way=getCommentList','icon-plgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-plgl'" style="width: 150px;">评论信息管理</a>
		</div>
...
<%--		    <a href="javascript:openTab('友情链接管理','linkManage.jsp','icon-link')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-link'" style="width: 150px">友情链接管理</a>--%>
		    <a href="javascript:openTab('友情链接管理','linkServlet?way=getLinkList','icon-link')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-link'" style="width: 150px">友情链接管理</a>
